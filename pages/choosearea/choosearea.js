            ...
            if (res.errMsg === "chooseImage:ok" &&
                ...
                that.setData({
                    ...
                    wx.navigateTo({
                      ...
                      url: '../process/process?img=' +that.data.src
                    })
                })
            }
        }
            ...
            setTimeout(function () {
              wx.canvasToTempFilePath({ //裁剪对参数
                ...
                success: function (res) {
                  ...
                  that.canvas.draw()
                  wx.hideLoading()
                  // console.log("截取出来的图片 :"+res.tempFilePath);
                  wx.navigateTo({
                    // url: '../mobilenet/mobilenet?img=' +res.tempFilePath
                    // url: '../mobilenet/mobilenet?img=' +that.data.image//带着图片跳转到另一个page
                    url: '../process/process?img=' +that.data.image
                  })
